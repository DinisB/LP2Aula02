...
namespace CatFromLastWeek
{
    ...
    {
        private static void Main(string[] args) // método
        {
            // Declarar os gatos
            Cat cat1, cat2; // instância 
            ...
            cat1 = new Cat("Lombriga"); // instância 
            cat2 = new Cat(
                "Minhoca", 99, Feed.Full, Mood.HyperActive | Mood.Grumpy); // instância 
        ...
        private static void ShowCat(Cat cat) // método
        {
            Console.WriteLine(
